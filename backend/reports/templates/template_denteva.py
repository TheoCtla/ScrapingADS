"""
Template Denteva — Même charte graphique que les autres templates.
Spécificités : Google uniquement, très simple (5 slides),
Clics RDV placeholder manuel.
"""
...
COVER_IMAGE = "img_denteva.jpg"


class TemplateDenteva(BaseTemplate):
    """Template pour Denteva — Google Ads uniquement."""
    ...
    def generate(self, data: dict) -> Presentation:
        ...
        # Slide 2 — Récap
        self._slide_recap(gen_curr, gen_prev, g_curr, g_prev, month_fr)
    ...
    def _slide_recap(self, gen_curr, gen_prev, g_curr, g_prev, month_fr):
        slide = self.prs.slides.add_slide(self.blank_layout)
        ...
        row1 = [
            ...
            {"label": "Clics RDV", "value": "—",
             "sub_label": "Nombre de clics trackés sur les boutons de prise de rendez-vous",
             "accent": PALETTE["gold"]},
        ]
